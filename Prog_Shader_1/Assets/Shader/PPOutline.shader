...
Shader "PPOutline"
{
	Properties
	{
		...
		_Float0("Float 0", Float) = 33.94
		_Float2("Float 2", Float) = 3.01
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag (ASEVaryingsDefault i  ) : SV_Target
			{
				...
				float lerpResult50 = lerp( ( ( ( ( temp_output_15_0 - ( _ProjectionParams.z * eyeDepth21 ) ) * _Float0 ) + ( ( temp_output_15_0 - ( _ProjectionParams.z * eyeDepth22 ) ) * _Float0 ) ) + ( ( ( temp_output_15_0 - ( _ProjectionParams.z * eyeDepth23 ) ) * _Float0 ) + ( ( temp_output_15_0 - ( _ProjectionParams.z * eyeDepth24 ) ) * _Float0 ) ) ) , 0.0 , _Float2);
				float4 color52 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				

				float4 color = ( tex2D( _MainTex, uv_MainTex ) + ( lerpResult50 * color52 ) );
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;65;274.0889,-292.695;Inherit;True;0;0;_MainTex;Pass;False;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;66;667.0889,-260.695;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;51;72.91859,154.4968;Inherit;False;Property;_Float2;Float 2;2;0;Create;True;0;0;0;False;0;False;3.01;3.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-607.0552,75.64771;Inherit;False;Property;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;33.94;33.94;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;52;136.7143,270.8701;Inherit;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=F96299610D8247DA339BA45182AF37A5E487F227